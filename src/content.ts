...
import { JSONRPC, DISCONNECT_ERROR, NEX_WALLET_FAVICON } from "core/common/rpc";
...
function initMsgGateway() {
  ...
  porter.onFullyDisconnect = () => {
    if (
      ...
      process.env.NEX_WALLET_DEV_ACTIVE_TAB_RELOAD === "true"
    ) {
    ...
    console.error(
      "NexWallet: Provider disconnected." +
