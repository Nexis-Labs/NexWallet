...
const Button = forwardRef<HTMLElement, ButtonProps>(
  (
    ...
    const classNamesList = classNames(
      ...
      "text-base font-bold",
      theme === "primary" &&
        "inline-flex h-12 animate-shimmer items-center justify-center rounded-md border border-transparent bg-[color:#C5FF4A] bg-[length:200%_100%] px-6 font-medium text-black transition-colors focus:outline-none focus:ring-2 focus:ring-green-400 focus:ring-offset-2 focus:ring-offset-black relative overflow-hidden before:absolute before:inset-0 before:rounded-md before:border-2 before:border-transparent before:transition-all before:duration-500 before:transform before:scale-0 hover:before:scale-100",
